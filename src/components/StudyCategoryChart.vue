<template>
  <div class="card p-4 sm:p-5">
    <div class="mb-4 flex items-start justify-between gap-3">
      <div>
        <h3 class="text-lg font-semibold text-primary">Study by Category</h3>
      </div>
...
const scopedStudyEntries = computed(() => {
  if (scope.value === 'all') return studyEntries.value
...
const categoryTotals = computed(() => {
  ...
  for (const entry of scopedStudyEntries.value) {
