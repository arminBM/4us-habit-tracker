...
>
  <span class="h-5 w-5">
    <IconBack />
        ...
        <h2 class="text-base font-semibold">Workout Insights</h2>
    ...
    >
      ...
      >
        <WorkoutDurationChart v-if="activeTab === 'duration'" class="h-full" />
        ...
        <WorkoutCategoryChart v-else-if="activeTab === 'category'" />

        <WorkoutMonthComparisonChart v-else-if="activeTab === 'comparison'" />
      </div>
    </main>
    ...
    <transition name="sheet">
      ...
      >
        ...
        >
          ...
          <WorkoutWeekDetailChart :weekIndex="selectedWeek" />
        </div>
      </div>
    </transition>
...
import WorkoutDurationChart from '../components/WorkoutDurationChart.vue'
import WorkoutWeeklyChart from '../components/WorkoutWeeklyChart.vue'
import WorkoutCategoryChart from '../components/WorkoutCategoryChart.vue'
import WorkoutWeekDetailChart from '../components/WorkoutWeekDetailChart.vue'
import WorkoutMonthComparisonChart from '../components/WorkoutMonthComparisonChart.vue'
